...
Gamma = 1.4;
f_act = 0.4778;
f=@(x) sqrt((Gamma + 1)/(Gamma - 1))*(atan(sqrt(((Gamma - 1)/(Gamma + 1))*(x^2 - 1)))) - (atan(sqrt((x^2) - 1))) - f_act; %Función dependiente de x.
...
x0 = 2; xi = 2.5; %Valor inicial.
Niter=20; %Número de máximo de iteraciones. Recomiendo usar 100.
