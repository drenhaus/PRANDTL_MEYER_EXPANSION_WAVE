...
namespace LibreriaClases
{
    public class Celda
    {
        ...
        #region FIRST COLUM COMPUTATION
        ...
        #endregion FIRST COLUM COMPUTATION
        ...
        #region PREDICTOR STEP FUNCTIONS
        ...
        #endregion PREDICTOR STEP FUNCTIONS

        #region CORRECTOR STEPS FUNCTIONS
        ...
        #endregion  CORRECTOR STEPS FUNCTIONS
        ...
        public void Wall_Bounday_Condition(double Gamma, double R_aire, double E, double theta)
        {
            ...
            double part1 = Math.Sqrt((Gamma + 1) / (Gamma - 1));
            double part2 = Math.Sqrt((Gamma - 1) / (Gamma + 1) * (M_cal* M_cal - 1));
            double part3 = Math.Atan(part2);
            double part4 = Math.Atan(Math.Sqrt(Math.Pow(M_cal, 2) - 1));

            double f_cal = part1 * part3 - part4;
